...
def run_debug(args):
    ...
    print(f"Invalid answers: {sum(1 for r in results if r['pred'] == INVALID)} ({100*invalid_rate:.1f}%)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dllm-algorithm", type=str, default="LowConfidenceFDFO", 
                        help="DLLM algorithm name")
    parser.add_argument("--dllm-algorithm-config", type=str, default=None,
